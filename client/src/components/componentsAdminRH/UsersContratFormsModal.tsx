                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-4 overflow-y-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
                        ...
                        <div>
                            ...
                            <DatePicker
                                selected={form.date_debut_contrat}
                                onChange={(d) => handleChange("date_debut_contrat", d)}
                        ...
                        <div>
                            ...
                            <DatePicker
                                selected={form.date_fin_contrat}
                                onChange={(d) => handleChange("date_fin_contrat", d)}
                                className="w-full px-3 py-2 border rounded-lg"
                                dateFormat="dd/MM/yyyy"
                                showMonthDropdown
                                showYearDropdown
                        ...
                        <div>
                            ...
                            <DatePicker
                                ...
                                onChange={(d) => handleChange("date_naissance", d)}
                                className="w-full px-3 py-2 border rounded-lg"
                                dateFormat="dd/MM/yyyy"
                                showMonthDropdown
                                showYearDropdown
                        ...
                        <div>
                            ...
                            <DatePicker
                                selected={form.date_integration}
                                onChange={(d) => handleChange("date_integration", d)}
                                className="w-full px-3 py-2 border rounded-lg"
                                dateFormat="dd/MM/yyyy"
                                showMonthDropdown
                                showYearDropdown
