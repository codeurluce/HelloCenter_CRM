...
import UsersContratDetailsModal, {
  Agent,
} from "./UsersContratDetailsModal.tsx";
...
export default function AgentList() {
  ...
  const filteredAgents = agents.filter((a) => {
    ...
    // Filtre site si choisi
    if (siteFilter && a.site?.id.toString() !== siteFilter) return false;
    ...
    return (
      ...
      (a.contrat?.situation_matrimoniale || "")
        .toLowerCase()
        .includes(search) ||
  ...
  return (
    <>
      <div className="relative pb-6 flex items-center gap-4">
        {/* Input texte */}
        <input
          type="text"
            ...
            {loading ? (
              ...
              filteredAgents.map((a) => (
                ...
                >
                    ...
                    <td className="px-6 py-3 text-gray-800">
                      {a.site ? (
                        <span
                          ...
                          style={{
                            backgroundColor: getColorForSite(a.site.name),
                          }}
                          title={a.site.name}
                        >
                          {a.site.name}
                  ...
                  <td className="px-6 py-3 text-gray-800">
                    {a.contrat?.date_fin_contrat
                      ? new Date(a.contrat.date_fin_contrat).toLocaleDateString(
                          "fr-FR"
                        )
                      : "-"}
                  </td>
